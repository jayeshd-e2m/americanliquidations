    ...
    <div class="flex items-center gap-7">
        ...
        <span>Water Berry - 
            ...
            if( $link ): 
                ...
                ?>
                <a class="text-black hover:underline hidden lg:block font-medium" itemprop="telephone" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
            <?php endif; ?>
        </span>
       <span>Milford - 
            <?php 
