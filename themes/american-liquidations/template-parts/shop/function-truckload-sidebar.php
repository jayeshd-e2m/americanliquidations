		...
		<form id="truckload-shop-filters">
			...
			<div class="filter-dropdown my-10">
				...
				<div class="price-range-wrapper" data-minprice="<?php echo esc_attr( $tl_min_price ); ?>" data-maxprice="<?php echo esc_attr( $tl_max_price ); ?>">
					<input type="text" id="tl-price-range" name="price_range" value="" />
					<div class="flex justify-between text-[12px] mt-2 font-medium">
						<span>$<span id="tl-min-price-label"><?php echo number_format( $tl_min_price ); ?></span></span>
						<span>$<span id="tl-max-price-label"><?php echo number_format( $tl_max_price ); ?></span></span>
					</div>
					<input type="hidden" name="min_price" id="tl-min-price" value="<?php echo esc_attr( $tl_min_price ); ?>">
					<input type="hidden" name="max_price" id="tl-max-price" value="<?php echo esc_attr( $tl_max_price ); ?>">
				</div>
			</div>
		</form>
	</div>
