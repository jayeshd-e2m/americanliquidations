...
<div class="bg-gray py-14">
    <form id="registrationForm" class="space-y-6">
        <div class="max-w-[830px] mx-auto p-8 md:p-12 bg-white rounded-[15px]">
            ...
            <div id="step1" class="">
                <div class="mb-12">
                    <div class="text-[24px] font-bold text-black mb-5 flex justify-between items-center font-barlow">Personal Information <span class="text-base font-medium text-black/40 font-inter">Step 1/2</span></div>
                ...
                <div class="flex items-center justify-between pt-14">
                    <button type="button" id="nextBtn" 
                        class="btn btn-red btn-arrow hover:bg-black">
                        NEXT
                    </button>
            ...
            <div id="step2" class="hidden">
                <div class="mb-12">
                    <div class="text-[24px] font-bold text-black mb-3 flex justify-between items-center font-barlow">Business Information <span class="text-base font-medium text-black/40 font-inter">Step 2/2</span></div>
                    <p class="text-gray-600 text-base">Lorem ipsum dolor sit amet consectetur. Justo cursus tortor id aliquam dapibus ipsum fermentum massa sit. Faucibus venenatis etiam elit eleifend. Vitae imperdiet..</p>
                </div>
                ...
                <div class="flex items-center justify-between pt-14 relative">
                    <button type="button" id="backBtn" 
                        class="absolute max-w-[120px] left-0 right-0 mx-auto bottom-[-40px] text-black/60 text-xs">
                        ← BACK
                    </button>
