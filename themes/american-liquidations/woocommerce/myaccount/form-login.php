...
<div class="page-description-header py-12">
    <div class="container">
        <h1 class="text-[36px] md:text-[44px] lg:text-[48px]"><?php echo $title ? esc_html($title) : 'Sign in'; ?></h1>
        <?php if ($description): ?>
            <div class="mt-6">
            ...
            <main class="login-form-section w-full md:w-[70%] lg:w-[calc(100%_-_300px)] custom-login-form-cover p-6 lg:p-12 bg-white rounded-[15px]">
                ...
                <?php if (isset($_SESSION['pending_2fa_user'])): ?>
                    ...
                    <form method="post" class="woocommerce-form woocommerce-form-2fa">
                        <div class="mb-6">
                            <label for="code"><?php _e('Enter the 2FA code sent to your email:'); ?></label>
                        </div>
                        <input type="text" name="code" id="code" maxlength="6" required autocomplete="one-time-code" class="input-text mb-6" />
                        <div class="flex gap-4 mt-4">
                            <button type="submit" name="submit_2fa_code" class="btn btn-red btn-arrow">
                                <?php _e('Verify Code'); ?>
                            </button>
                            <button type="submit" name="resend_2fa_code" class="btn btn-secondary">
                                <?php _e('Resend Code'); ?>
                            </button>
                        </div>
                    </form>
