				...
				<tbody>
					...
					foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
						...
						if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
							...
							<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
								...
								<td class="product-remove text-center">
									<?php
										echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
											...
											sprintf(
												'<a href="%s" class="remove mx-auto" aria-label="%s" data-product_id="%s" data-product_sku="%s"><img class="!w-4" src="'.site_url().'/wp-content/uploads/2025/05/cart-delete.svg" /></a>',
								...
								<td class="product-price product-card-content" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
									<div class="flex items-center gap-2 is-price">
										<?php
								...
								<td class="product-subtotal font-semibold" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
									<?php
					...
					<tr>
						<td colspan="6" class="actions">
							...
							<div class="cart-update-button">
							<button type="submit" class="btn<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
							</div>
