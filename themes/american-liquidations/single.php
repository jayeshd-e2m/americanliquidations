...
?>
	...
	<main id="primary" class="site-main">
		...
		?>
		<div class="blog-single-thumbnail py-[110px]" style="background-image: url(<?php echo $thumbnail; ?>); background-size: cover;">
			<div class="container relative">
				<div class="max-w-[850px] space-y-5">
					<h1 class="!text-[48px] text-white"><?php the_title(); ?></h1>
					...
					<div class="text-white/60"><?php echo wp_trim_words( get_the_excerpt(), 10, '...' ); ?></div>
				</div>
			</div>
		</div>
		<div class="py-24 body-content">
			<div class="container">
